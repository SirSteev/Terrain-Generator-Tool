...
namespace ImageModificationTest
{
    public class Perlin
    {
        // class from open source

        public static double OctavePerlin(int x, int y, int z, int octaves, double persistence)
        {
            double total = 0;
            double frequency = 1;
            double amplitude = 1;
            ...
            {
                total += perlin(Dx * frequency, Dy * frequency, Dz * frequency) * amplitude;
        ...
        public static double invertedLerp(double a, double b, double x)
        {
            return (x - a) / (b - a);
        }
    }
